...
4. **Аварийная сигнализация**
   ...
   - Звуковой сигнализатор включается только в критической (неисправимой) ситуации: когда отказал `Sensor 2` и одновременно недоступны резервные датчики `Sensor 3/4`.
